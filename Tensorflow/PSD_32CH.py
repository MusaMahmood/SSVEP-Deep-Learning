...
WEIGHT_VAR_CL1 = [2, 2, 1, BIAS_VAR_CL1]  # [5, NUMBER_DATA_CHANNELS, 1, 32]
WEIGHT_VAR_CL2 = [4, 4, BIAS_VAR_CL1, BIAS_VAR_CL2]  # [5, NUMBER_DATA_CHANNELS, 32, 64]


BIAS_VAR_FC1 = [1024]
WEIGHT_VAR_FC1 = [16*64*64, *BIAS_VAR_FC1]
...
def conv2d(x_, weights_):
    return tf.nn.conv2d(x_, filter=weights_, strides=STRIDE_CONV2D, padding='SAME')
